...
class HatikoInfo:
    ...
    closeLongSignal_list = ["close Longs on open", "TakeProfit_nearL1", "TakeProfit_nearL2", "TakeProfit_nearL3", "TakeProfit_nearL4",
                            "TakeProfit_L1", "TakeProfit_L2", "TakeProfit_L3", "TakeProfit_L4", "Long_Flag_Cancel"]
    closeShortSignal_list = ["close Shorts on open", "TakeProfit_nearS1", "TakeProfit_nearS2", "TakeProfit_nearS3", "TakeProfit_nearS4",
                             "TakeProfit_S1", "TakeProfit_S2", "TakeProfit_S3", "TakeProfit_S4", "Short_Flag_Cancel"]
    ignoreSignal_list = ["Long_Flag", "Short_Flag"]
